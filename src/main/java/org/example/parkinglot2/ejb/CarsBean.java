package org.example.parkinglot2.ejb;

import org.example.parkinglot2.common.CarDto;
import org.example.parkinglot2.common.CarPhotoDto;
import org.example.parkinglot2.entities.Car;
import jakarta.ejb.EJBException;
import jakarta.ejb.Stateless;
import jakarta.persistence.EntityManager;
import jakarta.persistence.PersistenceContext;
import jakarta.persistence.TypedQuery;
import org.example.parkinglot2.entities.CarPhoto;
import org.example.parkinglot2.entities.User;
...
public class CarsBean {
    ...
    private List<CarDto> copyCarsToDto(List<Car> cars) {
        List<CarDto> carDos = new ArrayList<>();
        ...
        for (Car car : cars) {
            CarDto dto = new CarDto(
                    ...
                    car.getLicensePlate(),
                    car.getParkingSpot(),
                    car.getOwner().getUsername()   // ownerName
            );
            carDos.add(dto);
        }
